...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 25px;
            background: linear-gradient(to bottom, #90EE90, #008B00);
            /* Green gradient */
            color: white;
            /* Text color for contrast with the gradient */
        }
        ...
        form {
            ...
            /* White background for the form itself */
            border-radius: 5px;
            /* Rounded corners for the form */
            padding: 20px;
            /* Padding for spacing within the form */
            margin: auto;
        ...
        input[type="date"] {
            ...
            /* Include padding in input width calculation */
        }
        ...
        input[type="submit"] {
            ...
            cursor: pointer;
            /* Indicate clickable behavior on hover */
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <div>
            <table>
                ...
                <tbody>
                    <?php
                    $con = mysqli_connect("localhost", "root", "", "oldagehome");
